...
class MoviesCategoriesListView extends StatefulWidget {
  const MoviesCategoriesListView({super.key});

  @override
  State<MoviesCategoriesListView> createState() =>
      _MoviesCategoriesListViewState();
}

class _MoviesCategoriesListViewState extends State<MoviesCategoriesListView> {
            ...
            child: SingleChildScrollView(
              ...
              child: ToggleButtons(
                ...
                onPressed: (int index) {
                  ...
                  BlocProvider.of<MoviesExploreCubit>(context).getMoviesExplore(
